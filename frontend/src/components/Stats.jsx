    ...
    <main id="stats" className="flex flex-col items-center justify-center px-6 py-20 hero">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl w-full mb-10">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="bg-white border-2 rounded border-black shadow-[12px_12px_0_#000] p-8 text-center hover:-translate-x-1 hover:-translate-y-1 hover:shadow-[17px_17px_0_#000] transition-transform"
          >
